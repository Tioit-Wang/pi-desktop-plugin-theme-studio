...
把 PI-Desktop 的外观调成你自己的样子：内置 5 套配色起手（QQ 2008 / Contrast / Mint Dark / Business Blue / China Red），改完一键应用 —— 应用窗口立刻换色，不需要重启。
...
| 步骤 | 说明 |
| --- | --- |
| 选主题 | 左栏是主题库：折叠后只剩左上角一颗悬浮按钮。分「我的主题 / 内置预设」两组；预设只读，复制一份即可改。 |
